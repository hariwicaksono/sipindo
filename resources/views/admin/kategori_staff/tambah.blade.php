...
<div class="modal-header py-2">
	<h6 class="modal-title" id="myModalLabel">Tambah Team Member</h6>
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
</div>
<div class="modal-body">
    
<form class="form-horizontal" action="{{ url('admin/kategori_staff/tambah') }}" method="post" accept-charset="utf-8">
{{ csrf_field() }}
