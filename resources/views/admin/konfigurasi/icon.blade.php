...
<form action="{{ url('admin/konfigurasi/proses_icon') }}" enctype="multipart/form-data" method="post" accept-charset="utf-8">
{{ csrf_field() }}
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <img src="{{ asset('uploads/image/'.$site->icon) }}" style="max-width:200px; height:auto;">
    </div>
...
<script type="text/javascript">
  ...
  $("#konfigurasiIcon .nav-link").addClass('active');
    }); 
  </script>